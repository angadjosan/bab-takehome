...
export function describeEvent(e: MarketEvent): Described {
  ...
  switch (e.eventName) {
    ...
    case "Purchased":
      return { title: `Purchase #${s(e, "purchaseId")} paid`, detail: `${fmtUsdc(b(e, "price"))} · environment #${s(e, "versionId")}`, tone: "accent", href: purchase };
    case "Delivered":
      return {
        title: `Key delivered for purchase #${s(e, "purchaseId")}`,
        detail: e.args.challengeDeadline !== undefined ? `Protection window ends ${fmtTime(Number(e.args.challengeDeadline))}` : undefined,
        tone: "info",
        href: purchase,
      };
    ...
    case "SelectionArmed":
      return { title: `Jury draw scheduled for dispute #${s(e, "disputeId")}`, detail: `Round ${s(e, "round")} · block ${s(e, "selectionBlock")}`, tone: "neutral", href: dispute };
    case "JurorsSelected": {
      const n = Array.isArray(e.args.jurors) ? e.args.jurors.length : undefined;
      return { title: `Jury drawn for dispute #${s(e, "disputeId")}`, detail: `Round ${s(e, "round")}${n !== undefined ? ` · ${n} jurors` : ""}`, tone: "info", href: dispute };
    }
    case "VoteCommitted":
    ...
    case "VerifierTimeout":
      return { title: "Review timed out", detail: `Dispute #${s(e, "disputeId")}`, tone: "warn", href: dispute };
    ...
    case "Rated":
      return { title: `Purchase #${s(e, "purchaseId")} rated ${Number(e.args.stars)} star${Number(e.args.stars) === 1 ? "" : "s"}`, detail: `Environment #${s(e, "versionId")}`, tone: "accent", href: purchase };
    ...
    case "ParamsUpdated":
      return { title: "Market terms updated", tone: "neutral" };
    case "PreviewRequested":
      return {
        title: `Preview paid for environment #${s(e, "versionId")}`,
        detail: e.args.fee !== undefined ? fmtUsdc(b(e, "fee")) : undefined,
        tone: "neutral",
        href: listing,
      };
    case "PreviewFeeReleased":
      return {
        title: "Preview fee paid out",
        detail: [e.args.fee !== undefined ? fmtUsdc(b(e, "fee")) : null, e.args.recipient !== undefined ? `to ${shortAddr(s(e, "recipient"))}` : null, e.args.versionId !== undefined ? `environment #${s(e, "versionId")}` : null]
          .filter(Boolean)
          .join(" · ") || undefined,
        tone: "neutral",
        href: e.args.versionId !== undefined ? listing : undefined,
      };
    case "PreviewFeeReclaimed":
      return {
        title: "Preview fee reclaimed by the seller",
        detail: [e.args.fee !== undefined ? fmtUsdc(b(e, "fee")) : null, e.args.versionId !== undefined ? `environment #${s(e, "versionId")}` : null].filter(Boolean).join(" · ") || undefined,
        tone: "warn",
        href: e.args.versionId !== undefined ? listing : undefined,
      };
