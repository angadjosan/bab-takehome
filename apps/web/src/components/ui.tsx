...
const PURCHASE_LABEL: Record<string, string> = { Funded: "Paid · waiting for key", Delivered: "Delivered", Disputed: "Problem reported", Refunded: "Refunded", Settled: "Complete" };
